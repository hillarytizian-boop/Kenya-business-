...
const LISTINGS = [
  ...
  {
    id: 5, category: "businesses", title: "Pharmacy – CBD",
    price: 5600000, priceLabel: "KES 5.6M", location: "CBD, Nairobi",
    description: "Well-established pharmacy in the city centre. Stock worth KES 2M included. Good rental income.",
    image: "💊", verified: true, featured: false, views: 2341, rating: 4.7, reviews: 34,
    seller: "Nairobi Pharmacy Ltd", sellerVerified: true, daysAgo: 7, badge: null,
    tags: ["Stock Included", "Central Location", "Good Returns"]
  },
  {
    id: 6, category: "businesses", title: "Car Wash & Detailing – Westlands",
    price: 1800000, priceLabel: "KES 1.8M", location: "Westlands, Nairobi",
    description: "Busy car wash with 5 bays. 3 years operation. Monthly revenue KES 300K+. Equipment included.",
    image: "🚗", verified: true, featured: false, views: 567, rating: 4.2, reviews: 45,
    seller: "CarCare Kenya", sellerVerified: true, daysAgo: 12, badge: null,
    tags: ["Equipment", "Busy Location", "Good Revenue"]
  },
  {
    id: 7, category: "businesses", title: "Electronics Shop – Mombasa Road",
    price: 3500000, priceLabel: "KES 3.5M", location: "Mombasa Road, Nairobi",
    description: "Electronic shop selling phones, TVs, and accessories. 4 years operation. Stock worth KES 1.5M.",
    image: "📱", verified: true, featured: false, views: 234, rating: 4.5, reviews: 23,
    seller: "Tech World", sellerVerified: true, daysAgo: 8, badge: null,
    tags: ["Stock Included", "Good Location", "Profitable"]
  },
  {
    id: 8, category: "businesses", title: "Laundromat – Kilimani",
    price: 750000, priceLabel: "KES 750K", location: "Kilimani, Nairobi",
    description: "Self-service laundromat with 8 machines. 2 years operation. Good location near apartments.",
    image: "🧺", verified: false, featured: false, views: 345, rating: 4.3, reviews: 56,
    seller: "Clean & Fresh", sellerVerified: false, daysAgo: 6, badge: null,
    tags: ["Self-Service", "Good Location", "Low Overhead"]
  },
  {
    id: 9, category: "businesses", title: "Restaurant – Ngong Road",
    price: 4200000, priceLabel: "KES 4.2M", location: "Ngong Road, Nairobi",
    description: "Popular restaurant serving African cuisine. 60 capacity. Fully equipped. Good reputation.",
    image: "🍽️", verified: true, featured: true, views: 789, rating: 4.8, reviews: 89,
    seller: "African Flavours", sellerVerified: true, daysAgo: 4, badge: "Hot",
    tags: ["Fully Equipped", "Good Reputation", "Profitable"]
  },
  {
    id: 10, category: "businesses", title: "Butchery – Umoja Estate",
    price: 1200000, priceLabel: "KES 1.2M", location: "Umoja, Nairobi",
    description: "Established butchery with cold room. 5 years operation. Good customer base. Monthly profit KES 200K+",
    image: "🥩", verified: true, featured: false, views: 456, rating: 4.6, reviews: 34,
    seller: "Fresh Meats", sellerVerified: true, daysAgo: 9, badge: null,
    tags: ["Cold Room", "Established", "Profitable"]
  },

  // ─── PROPERTIES (10) ──────────────────────────────────────────────────────────
  {
    id: 11, category: "properties", title: "3BR Apartment – Kilimani",
    price: 8500000, priceLabel: "KES 8.5M", location: "Kilimani, Nairobi",
    description: "Modern 3-bedroom apartment, 120sqm, fully fitted kitchen, secure parking, 24hr security.",
  ...
  {
    id: 12, category: "properties", title: "4BR Mansion – Runda Estate",
    price: 28000000, priceLabel: "KES 28M", location: "Runda, Nairobi",
    description: "Spacious 4-bedroom mansion on 0.5 acre. 2 living rooms, garden, swimming pool, staff quarters.",
  ...
  {
    id: 13, category: "properties", title: "Land 2.5 Acres – Kitengela",
    price: 12500000, priceLabel: "KES 12.5M", location: "Kitengela, Kajiado",
    description: "Prime development land with title deed. Access to water, electricity. Near new highway.",
  ...
  {
    id: 14, category: "properties", title: "Studio Apartment – CBD",
    price: 2800000, priceLabel: "KES 2.8M", location: "CBD, Nairobi",
    description: "Modern studio apartment in the heart of Nairobi. 35sqm, fully furnished.",
  ...
  {
    id: 15, category: "properties", title: "Commercial Building – Mombasa Road",
    price: 45000000, priceLabel: "KES 45M", location: "Mombasa Road, Nairobi",
    description: "Commercial building with ground floor shops and upper floors for offices. 10 tenants.",
  ...
  {
    id: 16, category: "properties", title: "Land 10 Acres – Naivasha",
  ...
  {
    id: 17, category: "properties", title: "2BR Bungalow – Nakuru",
    price: 3500000, priceLabel: "KES 3.5M", location: "Nakuru, Nakuru",
    description: "Cosy 2-bedroom bungalow with garden. Quiet neighborhood. Good for first-time buyers.",
    image: "🏡", verified: true, featured: false, views: 234, rating: 4.4, reviews: 8,
    seller: "Nakuru Homes", sellerVerified: true, daysAgo: 5, badge: null,
    tags: ["Garden", "Quiet", "First Time"]
  },
  {
    id: 18, category: "properties", title: "Warehouse – Industrial Area",
    price: 12000000, priceLabel: "KES 12M", location: "Industrial Area, Nairobi",
    description: "Large warehouse 500sqm with office space. Good for manufacturing or storage.",
    image: "🏭", verified: true, featured: false, views: 345, rating: 4.3, reviews: 6,
    seller: "Industrial Spaces", sellerVerified: true, daysAgo: 14, badge: null,
    tags: ["Large Space", "Office", "Good Access"]
  },
  {
    id: 19, category: "properties", title: "Beachfront Villa – Diani",
    price: 25000000, priceLabel: "KES 25M", location: "Diani, Kwale",
    description: "Luxury 5-bedroom villa on Diani beach. Private pool, staff quarters, stunning ocean views.",
    image: "🏖️", verified: true, featured: true, views: 678, rating: 5.0, reviews: 23,
    seller: "Diani Property Group", sellerVerified: true, daysAgo: 2, badge: "Featured",
    tags: ["Beachfront", "Pool", "Luxury"]
  },
  {
    id: 20, category: "properties", title: "Land 1 Acre – Karen",
    price: 8500000, priceLabel: "KES 8.5M", location: "Karen, Nairobi",
    description: "Prime 1-acre plot in Karen. Ready for construction. Good neighborhood.",
    image: "🌳", verified: true, featured: false, views: 456, rating: 4.7, reviews: 9,
    seller: "Karen Land Agency", sellerVerified: true, daysAgo: 8, badge: null,
    tags: ["Prime Location", "Ready to Build", "Good Neighborhood"]
  },

  // ─── VEHICLES (8) ─────────────────────────────────────────────────────────────
  {
    id: 21, category: "vehicles", title: "Toyota Land Cruiser V8 2019",
    price: 6200000, priceLabel: "KES 6.2M", location: "Karen, Nairobi",
    description: "Single owner, full service history, locally used. Pearl white, leather interior, sunroof.",
  ...
  {
    id: 22, category: "vehicles", title: "Toyota Hilux Double Cab 2021",
    price: 4500000, priceLabel: "KES 4.5M", location: "Thika, Kiambu",
    description: "Low mileage 35,000km. 4x4, automatic, A/C, reverse camera. Perfect for business.",
  ...
  {
    id: 23, category: "vehicles", title: "Nissan X-Trail 2020",
    price: 3500000, priceLabel: "KES 3.5M", location: "Nakuru, Nakuru",
  ...
  {
    id: 24, category: "vehicles", title: "Motorcycle – Boxer BM150",
  ...
  {
    id: 25, category: "vehicles", title: "Mercedes Benz E200 2018",
    price: 4800000, priceLabel: "KES 4.8M", location: "Westlands, Nairobi",
    description: "Elegant Mercedes E200. Well maintained. Full service history. Great condition.",
    image: "🚘", verified: true, featured: false, views: 678, rating: 4.6, reviews: 18,
    seller: "Luxury Auto", sellerVerified: true, daysAgo: 5, badge: null,
    tags: ["Luxury", "Well Maintained", "Full History"]
  },
  {
    id: 26, category: "vehicles", title: "Toyota Sienta 2020",
    price: 2800000, priceLabel: "KES 2.8M", location: "Mombasa, Mombasa",
    description: "Family-friendly 7-seater. Good condition. Low mileage. Ideal for large families.",
    image: "🚐", verified: true, featured: false, views: 234, rating: 4.4, reviews: 12,
    seller: "Mombasa Autos", sellerVerified: true, daysAgo: 9, badge: null,
    tags: ["7-Seater", "Family", "Low Mileage"]
  },
  {
    id: 27, category: "vehicles", title: "Isuzu D-Max 2021",
    price: 4200000, priceLabel: "KES 4.2M", location: "Thika, Kiambu",
    description: "Double cab pick-up. 4x4, diesel. 30,000km. Good for business and personal use.",
    image: "🚜", verified: true, featured: false, views: 345, rating: 4.7, reviews: 15,
    seller: "Pickup Kenya", sellerVerified: true, daysAgo: 4, badge: null,
    tags: ["Double Cab", "4x4", "Diesel"]
  },
  {
    id: 28, category: "vehicles", title: "VW Polo Vivo 2019",
    price: 1500000, priceLabel: "KES 1.5M", location: "CBD, Nairobi",
    description: "Well-maintained VW Polo. Good condition. 40,000km. Perfect for city driving.",
    image: "🚗", verified: false, featured: false, views: 456, rating: 4.2, reviews: 8,
    seller: "City Cars", sellerVerified: false, daysAgo: 12, badge: null,
    tags: ["City", "Good Condition", "Economical"]
  },

  // ─── JOBS (8) ─────────────────────────────────────────────────────────────────
  {
    id: 29, category: "jobs", title: "Senior Software Engineer – Fintech",
    price: 350000, priceLabel: "KES 350K/mo", location: "CBD, Nairobi",
    description: "Leading fintech company seeking Senior Software Engineer. React, Node.js, Python. 5+ years.",
  ...
  {
    id: 30, category: "jobs", title: "Sales Manager – FMCG",
    price: 180000, priceLabel: "KES 180K/mo", location: "Mombasa Road, Nairobi",
    description: "Multinational FMCG company looking for experienced Sales Manager. 10+ years experience.",
  ...
  {
    id: 32, category: "jobs", title: "Digital Marketing Specialist",
    price: 95000, priceLabel: "KES 95K/mo", location: "Karen, Nairobi",
    description: "E-commerce startup looking for digital marketing specialist. SEO, PPC, social media.",
  ...
  {
    id: 33, category: "jobs", title: "Accountant – Manufacturing",
    price: 85000, priceLabel: "KES 85K/mo", location: "Industrial Area, Nairobi",
    description: "Manufacturing company seeking Accountant with 3+ years experience. CPA required.",
    image: "📊", verified: true, featured: false, views: 567, rating: 4.3, reviews: 7,
    seller: "Manufacturing Ltd", sellerVerified: true, daysAgo: 8, badge: null,
    tags: ["CPA", "Manufacturing", "Full Time"]
  },
  {
    id: 34, category: "jobs", title: "Construction Project Manager",
    price: 150000, priceLabel: "KES 150K/mo", location: "Nairobi Wide",
    description: "Seeking experienced Project Manager for construction projects. 5+ years experience.",
    image: "🏗️", verified: true, featured: false, views: 234, rating: 4.5, reviews: 5,
    seller: "BuildCo Kenya", sellerVerified: true, daysAgo: 10, badge: null,
    tags: ["Construction", "Managerial", "5+ Years"]
  },
  {
    id: 35, category: "jobs", title: "Customer Service Manager",
    price: 75000, priceLabel: "KES 75K/mo", location: "Mombasa, Mombasa",
    description: "Leading telecom company seeking Customer Service Manager. 3+ years experience.",
    image: "📞", verified: true, featured: false, views: 345, rating: 4.1, reviews: 6,
    seller: "Telecom Kenya", sellerVerified: true, daysAgo: 6, badge: null,
    tags: ["Telecom", "Managerial", "Full Time"]
  },
  {
    id: 36, category: "jobs", title: "Graphic Designer – Creative Agency",
    price: 65000, priceLabel: "KES 65K/mo", location: "Westlands, Nairobi",
    description: "Creative agency seeking Graphic Designer. 2+ years experience. Adobe Suite required.",
    image: "🎨", verified: true, featured: false, views: 456, rating: 4.4, reviews: 8,
    seller: "Creative Hub", sellerVerified: true, daysAgo: 4, badge: "New",
    tags: ["Adobe Suite", "Creative", "Agency"]
  },

  // ─── SERVICES (8) ─────────────────────────────────────────────────────────────
  {
    id: 37, category: "services", title: "Professional Web Design & Development",
    price: 25000, priceLabel: "From KES 25K", location: "Nairobi (Remote)",
    description: "Premium websites, e-commerce stores, and web apps. 10+ years experience.",
  ...
  {
    id: 38, category: "services", title: "Professional Cleaning Services",
    price: 5000, priceLabel: "From KES 5K", location: "Nairobi Wide",
    description: "Commercial and residential cleaning. Carpet cleaning, office cleaning, post-construction.",
  ...
  {
    id: 39, category: "services", title: "Photography & Videography Services",
  ...
  {
    id: 40, category: "services", title: "IT Support & Networking Services",
    price: 10000, priceLabel: "From KES 10K", location: "Nairobi (Remote/On-site)",
    description: "IT support, network installation, server management, cybersecurity consulting.",
  ...
  {
    id: 41, category: "services", title: "Accounting & Tax Services",
    price: 15000, priceLabel: "From KES 15K", location: "Nairobi (Remote)",
    description: "Professional accounting, bookkeeping, and tax services. KRA compliant. QuickBooks experts.",
    image: "🧾", verified: true, featured: false, views: 345, rating: 4.7, reviews: 45,
    seller: "TaxPro Kenya", sellerVerified: true, daysAgo: 6, badge: null,
    tags: ["KRA", "QuickBooks", "Professional"]
  },
  {
    id: 42, category: "services", title: "Legal Services – Business Law",
    price: 20000, priceLabel: "From KES 20K", location: "CBD, Nairobi",
    description: "Business legal services. Company registration, contracts, employment law, intellectual property.",
    image: "⚖️", verified: true, featured: false, views: 234, rating: 4.9, reviews: 23,
    seller: "LegalAdvice KE", sellerVerified: true, daysAgo: 9, badge: null,
    tags: ["Business Law", "Contracts", "Registration"]
  },
  {
    id: 43, category: "services", title: "Plumbing & Electrical Services",
    price: 2500, priceLabel: "From KES 2.5K", location: "Nairobi Wide",
    description: "Professional plumbing and electrical services. Licensed and insured. 24/7 emergency service.",
    image: "🔧", verified: true, featured: false, views: 456, rating: 4.6, reviews: 78,
    seller: "FixIt Kenya", sellerVerified: true, daysAgo: 3, badge: null,
  ...
  },
  {
    ...
    description: "Full-service event planning and catering. Weddings, corporate events, birthdays, and more.",
    image: "🎊", verified: true, featured: false, views: 234, rating: 4.8, reviews: 56,
    seller: "EventPro Kenya", sellerVerified: true, daysAgo: 7, badge: null,
    tags: ["Weddings", "Corporate", "Catering"]
  },

  // ─── ELECTRONICS (6) ──────────────────────────────────────────────────────────
  {
    id: 45, category: "electronics", title: "iPhone 15 Pro Max 256GB – New",
  ...
  {
    id: 46, category: "electronics", title: "Samsung QLED 65\" TV – 2024",
  ...
  {
    id: 47, category: "electronics", title: "MacBook Pro M3 Pro 2024",
  ...
  {
    id: 48, category: "electronics", title: "PlayStation 5 – Disc Edition",
  ...
  {
    id: 49, category: "electronics", title: "Dell XPS 15 – 2024",
    price: 280000, priceLabel: "KES 280K", location: "Mombasa, Mombasa",
    description: "Dell XPS 15 with Intel i9, 32GB RAM, 1TB SSD. Perfect for developers and creatives.",
    image: "💻", verified: true, featured: false, views: 456, rating: 4.8, reviews: 34,
    seller: "Dell Kenya", sellerVerified: true, daysAgo: 5, badge: null,
    tags: ["i9", "32GB", "1TB SSD"]
  },
  {
    id: 50, category: "electronics", title: "AirPods Pro 2 – New",
    price: 35000, priceLabel: "KES 35K", location: "CBD, Nairobi",
    description: "Brand new AirPods Pro 2. Sealed box. Noise cancellation, spatial audio. Warranty included.",
    image: "🎧", verified: true, featured: false, views: 234, rating: 4.7, reviews: 56,
    seller: "Apple Kenya", sellerVerified: true, daysAgo: 2, badge: "New",
    tags: ["Sealed", "Warranty", "Noise Cancelling"]
  },

  // ─── AGRICULTURE (4) ──────────────────────────────────────────────────────────
  {
    id: 51, category: "agriculture", title: "2-Acre Farm – Limuru (Title Deed Ready)",
    price: 1800000, priceLabel: "KES 1.8M", location: "Limuru, Kiambu",
    description: "2-acre fertile farm land, red soil, good rainfall. Power connected. Access road. Title deed ready.",
  ...
  {
    id: 52, category: "agriculture", title: "5-Acre Greenhouse Farm – Nanyuki",
  ...
  {
    id: 53, category: "agriculture", title: "1-Acre Land – Kericho (Tea Growing)",
  ...
  {
    id: 54, category: "agriculture", title: "Dairy Farm – 15 Cows + Equipment",
    price: 3200000, priceLabel: "KES 3.2M", location: "Nakuru, Nakuru",
    description: "Established dairy farm with 15 cows, milking equipment, and 3 acres of pasture. Good returns.",
    image: "🐄", verified: true, featured: false, views: 456, rating: 4.6, reviews: 12,
    seller: "Nakuru Dairy", sellerVerified: true, daysAgo: 8, badge: null,
    tags: ["Dairy", "Equipment", "Established"]
  },

  // ─── FASHION (4) ──────────────────────────────────────────────────────────────
  {
    id: 55, category: "fashion", title: "Boutique Stock – Ladies Fashion (Bulk)",
    price: 45000, priceLabel: "KES 45K/lot", location: "Eastleigh, Nairobi",
    description: "Wholesale ladies dresses, tops, and skirts. 200 pieces per lot. Turkish fabric.",
  ...
  {
    id: 56, category: "fashion", title: "Premium African Wear Collection",
    price: 15000, priceLabel: "From KES 15K", location: "Mombasa, Mombasa",
    description: "High-quality African fashion designs. Kitenge, Kente, and modern African wear.",
  ...
  {
    id: 57, category: "fashion", title: "Shoe Store Stock – Men's & Women's",
    price: 120000, priceLabel: "KES 120K/lot", location: "CBD, Nairobi",
    description: "Wholesale shoes lot - 300 pairs. Various styles and sizes. Good quality.",
  ...
  {
    id: 58, category: "fashion", title: "Custom Suits & Tailoring Business",
    price: 850000, priceLabel: "KES 850K", location: "Westlands, Nairobi",
    description: "Established tailoring business with equipment, fabric stock, and loyal customer base.",
    image: "👔", verified: true, featured: false, views: 234, rating: 4.7, reviews: 34,
    seller: "TailorMade KE", sellerVerified: true, daysAgo: 11, badge: null,
    tags: ["Equipment", "Customer Base", "Profitable"]
  },
  ...
  {
    id: 60, category: "education", title: "Online Tutoring Services",
  ...
  // ─── HEALTHCARE (2) ───────────────────────────────────────────────────────────
  {
    id: 61, category: "healthcare", title: "Dental Clinic Equipment Lot",
    price: 2800000, priceLabel: "KES 2.8M", location: "Westlands, Nairobi",
    description: "Complete dental clinic equipment. 2 chairs, X-ray machine, sterilizer, all instruments.",
  ...
  {
    id: 62, category: "healthcare", title: "Pharmacy – Established Business",
...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-outline { background: white; color: ${COLORS.green}; border: 1.5px solid ${COLORS.green}; cursor: pointer; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; border-radius: 10px; transition: all 0.18s; }
    .btn-outline:hover { background: ${COLORS.greenLight}; }
    ...
    .badge-purple { background: ${COLORS.purpleLight}; color: ${COLORS.purple}; }
    
    ::-webkit-scrollbar { width: 6px; }
    ::-webkit-scrollbar-track { background: ${COLORS.surface}; }
    ::-webkit-scrollbar-thumb { background: ${COLORS.border}; border-radius: 3px; }

    .skeleton { background: linear-gradient(90deg, ${COLORS.surface} 25%, ${COLORS.borderLight} 50%, ${COLORS.surface} 75%); background-size: 200% 100%; animation: skeleton-load 1.4s infinite; border-radius: 8px; }
...
function Navbar({ view, setView, user, setUser }) {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      ...
      setUser({ name: "Hillary Kamau", email: "hillary@tiziantech.co.ke", role: "seller" });
      ...
      {isLoginOpen && (
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: "0 24px 64px rgba(0,0,0,0.2)", position: "relative", maxHeight: "90vh", overflowY: "auto",
          }} onClick={(e) => e.stopPropagation()}>
            <button onClick={() => setIsLoginOpen(false)}
              style={{ position: "absolute", top: 16, right: 16, background: "none", border: "none", cursor: "pointer", fontSize: 20, color: COLORS.inkFaint }}>
              ✕
            </button>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              <div style={{ fontSize: 48, marginBottom: 8 }}>🇰🇪</div>
              <h2 className="jakarta" style={{ fontSize: 24, fontWeight: 800, color: COLORS.ink, marginBottom: 4 }}>Welcome Back</h2>
              <p style={{ fontSize: 14, color: COLORS.inkMed }}>Sign in to access your dashboard</p>
            </div>
            <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: COLORS.inkMed, display: "block", marginBottom: 6 }}>Email Address</label>
                <input
                  type="email"
                  value={loginEmail}
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${COLORS.border}`, borderRadius: 10,
                    fontSize: 14, color: COLORS.ink, background: "white"
                  }}
                  required
                />
              </div>
              ...
              {loginError && (
                <div style={{ padding: "10px 14px", background: COLORS.redLight, color: COLORS.red, borderRadius: 8, fontSize: 13 }}>
                  {loginError}
                </div>
              )}
              <button
              ...
              <div style={{ textAlign: "center", fontSize: 13, color: COLORS.inkFaint }}>
                Don't have an account? <span style={{ color: COLORS.green, fontWeight: 600, cursor: "pointer" }}>Register</span>
              </div>
            </form>
          </div>
        </div>
